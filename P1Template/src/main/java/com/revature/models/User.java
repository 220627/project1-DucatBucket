...
public class User {
	...
	public User(int ers_users_id, String ers_username, String user_first_name, String user_last_name, String user_email,
			UserRoles user_role) {
		super();
	...
	public User(int ers_users_id, String ers_username, String ers_password, String user_first_name,
			String user_last_name, String user_email, UserRoles user_role) {
		super();
		this.ers_users_id = ers_users_id;
		this.ers_username = ers_username;
